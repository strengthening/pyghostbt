CREATE TABLE `future_account_flow_strategy` (
  ...
  `settle_mode` tinyint(4) NOT NULL DEFAULT '1',
  `settle_currency` varchar(20) NOT NULL DEFAULT 'btc' COMMENT 'the settle currency',
  ...
  KEY `exchange` (`exchange`,`settle_mode`,`settle_currency`,`subject`,`timestamp`),
