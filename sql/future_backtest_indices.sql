CREATE TABLE `future_backtest_indices` (
  ...
  `indices_value` text,
  `interval` varchar(10) NOT NULL COMMENT 'The indices interval: 1min/15min/1h/4h/1day/1week',
  `timestamp` bigint(13) NOT NULL COMMENT 'The indices start timestamp',
  `date` datetime COMMENT 'The indices start date',
