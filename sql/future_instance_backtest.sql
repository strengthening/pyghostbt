...
-- some columns about the asset
  ...
  `open_place_type` varchar(10) NOT NULL DEFAULT 'taker' COMMENT 'taker maker',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `symbol` (`symbol`, `exchange`, `contract_type`, `strategy`, `start_timestamp`, `backtest_id`),
