...
-- some columns about the asset
  ...
  `open_start_timestamp` bigint(13) '开仓开启时间戳',
  `open_start_datetime` datetime,
  `open_finish_timestamp` bigint(13),
  `open_finish_datetime` datetime,
  ...
  `liquidate_start_timestamp` bigint(13),
  `liquidate_start_datetime` datetime,
  `liquidate_finish_timestamp` bigint(13),
  `liquidate_finish_datetime` datetime,
