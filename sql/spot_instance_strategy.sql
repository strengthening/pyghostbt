CREATE TABLE `spot_instance_strategy` (
...
-- some columns about the asset
  `asset_total` decimal(20,8) COMMENT 'the total account asset for spot',
  `asset_freeze` decimal(20,8) COMMENT 'the spot account freeze asset for this instance',
