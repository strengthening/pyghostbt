CREATE TABLE `swap_asset_strategy` (
  ...
  `settle_mode` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1: basis currency mode, 2: counter currency mode',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `symbol` (`symbol`, `exchange`, `settle_mode`, `timestamp`, `settle_currency`),
